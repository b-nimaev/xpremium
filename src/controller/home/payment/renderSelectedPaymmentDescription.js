...
function default_1(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var message, payment, message_1;
        return __generator(this, function (_a) {
            message = "<b>".concat(title[ctx.session.plan], " \nSelected payment: ").concat(messages[ctx.session.payment], "</b>");
            ...
            if (ctx.message) {
                ...
                message_1 = "<b>".concat(title[ctx.session.plan], " \nSelected payment: ").concat(messages[ctx.session.payment], "</b>");
                ctx.editMessageText(message_1, extra);
                ctx.answerCbQuery();
            }
            return [2 /*return*/];
        });
